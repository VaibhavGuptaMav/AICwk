...
jct2 = networld.junctionDef(x=30, y=0, cap=2, canStop=True, src=trafficSrcMajor, sink=trafficSinkMajor)
jct3 = networld.junctionDef(x=49, y=0, cap=2, canStop=True, src=trafficSrcMinor, sink=trafficSinkMinor)
jct3A = networld.junctionDef(x=40, y=5, cap=2, canStop=True)
...
jct6A = networld.junctionDef(x=30, y=10, cap=8, canStop=True, fareProb=fareProbPopular, maxTraffic=12, src=trafficSrcMajor, sink=trafficSinkDrain)
jct9 = networld.junctionDef(x=40, y=10, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12)
jct10 = networld.junctionDef(x=49, y=10, cap=2, canStop=True, src=trafficSrcSignificant, sink=trafficSinkSignificant)
jct7A = networld.junctionDef(x=15, y=15, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12)
...
jct18A = networld.junctionDef(x=15, y=35, cap=4, canStop=True, fareProb=fareProbSemiPopular, maxTraffic=12)
jct19 = networld.junctionDef(x=20, y=30, cap=4, canStop=True, fareProb=fareProbSemiPopular)
jct20 = networld.junctionDef(x=24, y=35, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12, src=trafficSrcMajor, sink=trafficSinkMajor)
...
junctions = [jct0,jct1,jct2,jct3,jct3A,jct4,jct5,jct6,jct6A,jct7,jct7A,jct8,jct9,jct10,jct11,jct12,jct13,jct14,jct15,
             jct16,jct17,jct18,jct18A,jct19,jct20,jct21,jct22,jct23,jct24,jct25,jct26,jct27,jct28,jct29,jct30,jct31]
...
strt4S = networld.streetDef((10,10), (15,15), 3, 7, biDirectional=True)
...
strt9N = networld.streetDef((10,20), (15,15), 1, 5, biDirectional=True)
strt9 = networld.streetDef((10,20), (20,20), 2, 6, biDirectional=True)
strt10 = networld.streetDef((10,24), (20,24), 2, 6, biDirectional=True)
strt11 = networld.streetDef((10,35), (15,35), 2, 6, biDirectional=True)
strt12 = networld.streetDef((10,35), (15,40), 3, 7, biDirectional=True)
strt13 = networld.streetDef((10,40), (15,40), 2, 6, biDirectional=True)
strt13N = networld.streetDef((15,15), (20,10), 1, 5, biDirectional=True)
strt13S = networld.streetDef((15,15), (20,20), 3, 7, biDirectional=True)
...
strt19 = networld.streetDef((20,10), (30,10), 2, 6, biDirectional=True)
...
strt25 = networld.streetDef((15,35), (24,35), 2, 6, biDirectional=True)
strt25S = networld.streetDef((15,35), (15,40), 4, 0, biDirectional=True)
...
strt29N = networld.streetDef((24,15), (30,10), 1, 5, biDirectional=True)
...
strt35S = networld.streetDef((30,15), (40,10), 1, 5, biDirectional=True)
...
strt37N = networld.streetDef((30,10), (30,15), 4, 0, biDirectional=True)
strt38 = networld.streetDef((30,10), (40,5), 1, 5, biDirectional=True)
strt38E = networld.streetDef((30,10), (40,10), 2, 6, biDirectional=True)
strt39 = networld.streetDef((30,24), (40,30), 3, 7, biDirectional=True)
strt39E = networld.streetDef((30,30), (40,30), 2, 6, biDirectional=True)
strt40 = networld.streetDef((30,40), (40,40), 2, 6, biDirectional=True)
strt41 = networld.streetDef((30,0), (30,10), 4, 0, biDirectional=True)
strt41N = networld.streetDef((40,5), (49,0), 1, 5, biDirectional=True)
strt41E = networld.streetDef((40,5), (40,10), 4, 0, biDirectional=True)
strt42 = networld.streetDef((40,10), (40,30), 4, 0, biDirectional=True)
strt43 = networld.streetDef((40,30), (40,40), 4, 0, biDirectional=True)
strt44 = networld.streetDef((15,35), (20,30), 1, 5, biDirectional=True)
strt45 = networld.streetDef((40,10), (49,10), 2, 6, biDirectional=True)
strt46 = networld.streetDef((40,30), (49,30), 2, 6, biDirectional=True)
strt47 = networld.streetDef((40,40), (49,49), 3, 7, biDirectional=True)

streets = [strt0,strt1,strt2,strt3,strt4,strt4S,strt5,strt6,strt7,strt8,
           strt9,strt9N,strt10,strt11,strt12,strt13,strt13N,strt13S,strt14,strt15,
           strt16,strt17,strt18,strt19,strt20,strt21,strt22,strt23,strt24,
           strt25,strt25S,strt26,strt27,strt28,strt29,strt29N,strt30,strt31,
           strt32,strt33,strt34,strt35,strt35S,strt36,strt37,strt37N,strt38,strt38E,
           strt39,strt39E,strt40,strt41,strt41N,strt41E,strt42,strt43,strt44,strt45,strt46,strt47]
...
def runRoboUber(worldX,worldY,runTime,stop,junctions=None,streets=None,interpolate=False,outputValues=None,**args):
   ...
   taxi2 = taxi.PsychoTaxi(world=svcArea,taxi_num=102,service_area=svcMap,start_point=(15,49)) if psychoID == 2 else taxi.Taxi(world=svcArea,taxi_num=102,service_area=svcMap,start_point=(15,49))
